...
\hline
\textbf{Command Code} & \textbf{Command Name} & \textbf{Car ID} & \textbf{Car Name} & \textbf{State Name}& \textbf{States Code} \\
\hline
\hline

\textsf{[0x04]} & \textsf{CAR\_CON\_CMD}  &     \textsf{0x00}  &   \textsf{Car 1}    &  \textsf{connected}   & \textsf{[0x00:1]} \\
                &                         &                    &                     &  \textsf{notconnected} & \textsf{[0x01:1]} \\
\hline
\hline
\end{tabular}}
\caption{A Car Account Access Command}
\end{table}
